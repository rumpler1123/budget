    ...
    <div class="jumbotron dark-bg">
      ...
      <form action="" method="POST" id="kalkulator">
        ...
        <div class="buttons d-flex justify-content-center">
          ...
          <!-- update gomb -->
          <button type="submit" class="btn btn-warning mr-3 hiddenBtns" id="updateBtn"><i class="fas fa-pencil-alt"></i> Update</button>
          <!-- vissza gomb -->
          <button type="submit" class="btn btn-secondary hiddenBtns" id="backBtn"><i class="fas fa-chevron-left"></i> Vissza</button>
